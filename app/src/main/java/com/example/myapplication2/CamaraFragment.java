...
public class CamaraFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedStateInstance){
        ...
        View view = inflater.inflate(R.layout.fragment_camara, parent, false);
        ...
        tl_age = view.findViewById(R.id.text_layout_age);
        tl_location = view.findViewById(R.id.text_layout_location);
